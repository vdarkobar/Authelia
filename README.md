...
Setup <a href="https://accounts.google.com/signin/v2/identifier?flowName">Gmail account</a> for *Authentification Notifier service*. Protect the account with *2-Step Verification* and then create <a href="https://myaccount.google.com/u/1/apppasswords">App-Password</a> for Authelia. 
